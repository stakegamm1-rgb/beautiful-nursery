          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '50px', alignItems: 'center' }}>
            ...
            >
              <div style={{ position: 'relative', width: '250px', height: '250px' }}>
                ...
                <img
                  src={meImage}
                  alt="Riyaz Sir - Beautiful Nursery"
            ...
            >
              <h2 className="mission-h2" style={{ fontSize: '3rem', color: 'var(--dark-green)', marginBottom: '20px', lineHeight: 1.2 }}>Our Mission at <br /><span style={{ color: 'var(--primary)' }}>Beautiful Nursery</span></h2>
