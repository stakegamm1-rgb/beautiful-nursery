...
const ProductDetail = () => {
  ...
  const handleShare = () => {
    if (navigator.share) {
      navigator.share({
        title: product.name,
        text: `Check out this beautiful ${product.name} at Beautiful Nursery!`,
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '40px' }}>
          ...
          <div style={{ flex: '1 1 50%', display: 'flex', flexDirection: 'column' }}>
            ...
            <p style={{ color: '#555', fontSize: '15px', lineHeight: '1.8', marginBottom: '30px' }}>
              The {product.name} is a stunning addition to any space, perfectly curated by Beautiful Nursery. Known for its air-purifying qualities and lush foliage, it thrives with minimal care. Delivered fresh, healthy, and securely potted.
            </p>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '50px', marginBottom: '40px' }}>
            ...
            <div style={{ flex: '1 1 500px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
              ...
              <p style={{ color: '#666', lineHeight: 1.6 }}>
                Every plant from Beautiful Nursery is hand-picked, thoroughly inspected, and securely packed. Over {product.reviewCount} customers have trusted us to bring greenery into their lives. Read what they have to say below!
              </p>
            </div>
          </div>
          {/* Individual Reviews */}
